...
anova(lm.multi)
summary(lm.multi)
emmeans(lm.multi, specs = pairwise ~ FH * apoe4 * DRS_noAP, adjust = "tukey",type="response",pbkrtest.limit = 3564)
...
# volume control
ggscatter(MRIsubsample, x="rh_pmECDTI_volume", y="GCmagnitude_allRuns_pmECDTI_right_6",
...
# tSNR control
ggscatter(PITchange.PREVENTmeta.MRI, x="GCmagnitude_allRuns_pmECDTI_right_6", y="meanADerror",facet.by = c("FH","CAIDELabs_noAPOE"),color="genderLabs",
          add="reg.line",conf.int=TRUE, xlab="tSNR", ylab="Magnitude of grid cell like representations") +
  stat_cor(method="pearson")

table(MRIsubsample$CAIDELabs_noAPOE,MRIsubsample$Risk)
...
Again exchange below FH factor for apoe4 or DRS_noAP

#### Hereditary linear regression
##### 6-fold
```{r}
...
##### 4-fold
```{r}
lm.GCchange <- lm(data=PITchange.PREVENTmeta.MRI,meanADerror~GCmagnitude_allRuns_pmECDTI_right_4 + genderLabs + nbeduc + encrypt_age)
...
##### 5-fold
```{r}
lm.GCchange <- lm(data=PITchange.PREVENTmeta.MRI,meanADerror~GCmagnitude_allRuns_pmECDTI_right_5 + genderLabs + nbeduc + encrypt_age)
summary(lm.GCchange)
anova(lm.GCchange)
```
...
##### 7-fold
```{r}
lm.GCchange <- lm(data=PITchange.PREVENTmeta.MRI,meanADerror~GCmagnitude_allRuns_pmECDTI_right_7+genderLabs + nbeduc + encrypt_age)
summary(lm.GCchange)
anova(lm.GCchange)
```
...
```{r}
#6-fold
lm_ADerror<-lm(data=PITchange.PREVENTmeta.MRI, meanADerror ~ GCmagnitude_allRuns_pmECDTI_right_6 * DRS_noAP  + genderLabs + encrypt_age + nbeduc)
summary(lm_ADerror)
anova(lm_ADerror)

#1-fold
lm_ADerror<-lm(data=PITchange.PREVENTmeta.MRI, meanADerror ~ GCmagnitude_allRuns_pmECDTI_right_1 * DRS_noAP  + genderLabs + encrypt_age + nbeduc)
summary(lm_ADerror)
anova(lm_ADerror)
...
#### Heaxidrectional model comparison
...
lm.GCchange <- lm(data=PITchange.PREVENTmeta.MRI,meanADerror~GCmagnitude_allRuns_pmECDTI_right_1 + genderLabs + nbeduc + encrypt_age)
summary(lm.GCchange)
anova(lm.GCchange)

# full risk model on association
lm.GCchange <- lm(data=PITchange.PREVENTmeta.MRI,meanADerror~GCmagnitude_allRuns_pmECDTI_right_1*FH*apoe4*DRS_noAP*genderLabs + nbeduc + encrypt_age)
summary(lm.GCchange)
anova(lm.GCchange)

#effect of risk on signal
lm.GCchange <- lm(data=PITchange.PREVENTmeta.MRI,GCmagnitude_allRuns_pmECDTI_right_1~FH*apoe4*DRS_noAP*genderLabs + nbeduc + encrypt_age)
summary(lm.GCchange)
anova(lm.GCchange)
```
...
##### Mean orientations
```{r}
gghistogram(PITchange.PREVENTmeta.MRI, x="MeanOrientation_allRuns_pmECDTI_right_1", bins=6, facet.by = "genderLabs",xlab = "Mean orientation of unimodal grid-like signal", ylab = "Count")

# rayleigh test performed in Matlab, code pasted below
#angles_all = deg2rad([54.281,0.296,221.543,134.450,320.715,265.653,81.314,284.083,111.231,338.068,258.530,188.008,116.557,228.334,119.944,91.343, 104.766,211.165,16.320,226.473,21.216, 289.958 ,200.839, 209.703, #172.077,166.085,214.894,118.685,43.881,93.068,269.919, 63.335,75.551, 250.183, 172.742, 202.117, 258.144, 331.186, 150.661, 206.118,  21.353,  84.928, 152.813,  #96.953, 126.640,  14.680, 270.152,  95.424,30.150,8.293,71.399]);

#angles_male = deg2rad([221.5, 134.4, 284.1, 338.1, 258.5,188.0,228.3,119.9,91.3, 104.8, 211.2, 16.3, 226.5,  21.2, 166.1, 118.7, 250.2, 258.1, 150.7, 206.1, 152.8, 126.6,270.2, 195.4]);

#angles_female = deg2rad([54.281,0.296,320.715,265.653,81.314, 111.231, 116.557, 289.958, 200.839, 209.703, 172.077,214.894, 243.88, 93.068, 269.919, 63.335  75.551 172.742, 202.117, 331.186, 21.353, 84.928, 96.953, 14.680,30.150, 8.293,71.399]);

#addpath('/X/X/MATLAB/CircStat2012a')
#[pval,z] = circ_rtest(angles_female);
...
# 1b
setwd("X")
png(filename="Panel1B.png", res=600, width=4500, height=2800)
ggscatter(PITchange.PREVENTmeta, x="DRS_noAP",y="meanADerror",
  ...
  stat_cor(method="pearson",digits=2,size = 6) +
...
# 1c
setwd("X")
png(filename="Panel1C.png", res=600, width=4500, height=3600)
p <- ggbarplot(filter(PITchange.PREVENTmeta, !is.na(apoe4)), 
               x="Multi-hereditary risk",y="meanADerror",color="Multi-hereditary risk",fill="Multi-hereditary risk",
...
# 1d
setwd("X")
png(filename="Panel1D.png", res=600, width=6000, height=3600)
p <- ggbarplot(filter(PITchange.PREVENTmeta, !is.na(apoe4)), x="Multi-hereditary risk",y="meanADerror",
               color="Multi-hereditary risk",fill="Multi-hereditary risk",
               add=c("mean_se","jitter"),ylab = "Change in location error (m)",
               facet.by="genderLabs",ggtheme=theme_minimal()) +
  scale_color_manual(values=c("#4A6990","#7AA6DC","#003C67","#EFC000")) +
  scale_fill_manual(values=c("#003C6766","#4A699066","#7AA6DC66","#EFC00066")) +
  theme(strip.text = element_text(size=18),
        axis.text.x = element_text(size=16),
...
# 1e
setwd("X")
png(filename="Panel1E.png", res=600, width=4500, height=3600)
p <- ggbarplot(filter(PITchange2.PREVENTmeta, !is.na(apoe4)), x="Multi-hereditary risk",y="meanADerror",
               color="Multi-hereditary risk",fill="Multi-hereditary risk",add=c("mean_se","jitter"),
               ylab = "Change in location error (m)",ggtheme=theme_minimal()) +
  scale_color_manual(values=c("#4A6990","#7AA6DC","#003C67","#EFC000")) +
  scale_fill_manual(values=c("#003C6766","#4A699066","#7AA6DC66","#EFC00066")) +
  theme(strip.text = element_text(size=18),
        axis.text.x = element_text(size=16),
...
#2B1
setwd("X")
png(filename="Panel2B1.png", res=600, width=4500, height=2600)
ggscatter(PITchange.PREVENTmeta, x="DRS_noAP",y="meanAAerror",
          add = "reg.line",conf.int = TRUE,color="#3B3B3B",
          xlab = "CAIDE DRS", ylab = "Change in angular error (deg)",ggtheme=theme_minimal()) +
  stat_cor(method="pearson",digits=2,size = 6) +
  theme(strip.text = element_text(size=18),
        axis.text.x = element_text(size=16),
        axis.text.y = element_text(size=16),
...
#2B2
setwd("X")
png(filename="Panel2B2.png", res=600, width=4500, height=2600)
ggscatter(PITchange.PREVENTmeta, x="DRS_noAP",y="meanDdifferrorAbs",
          add = "reg.line",conf.int = TRUE,color="#3B3B3B",
          xlab = "CAIDE DRS", ylab = "Change in distance error (m)",ggtheme=theme_minimal()) +
  stat_cor(method="pearson",digits=2,size = 6,label.y = 0.5) +
  theme(strip.text = element_text(size=18),
        axis.text.x = element_text(size=16),
        axis.text.y = element_text(size=16),
        axis.title.x = element_text(size=18),
...
#2c1
setwd("X")
png(filename="Panel2C1.png", res=600, width=5500, height=3600)
ggbarplot(filter(PITchange.PREVENTmeta, !is.na(apoe4)), 
               x="Multi-hereditary risk",y="meanAAerror",color="Multi-hereditary risk",fill="Multi-hereditary risk",
               add=c("mean_se","jitter"),ylab = "Change in angular error (deg)",ggtheme=theme_minimal()) +
  scale_color_manual(values=c("#4A6990","#7AA6DC","#003C67","#EFC000")) +
  scale_fill_manual(values=c("#003C6766","#4A699066","#7AA6DC66","#EFC00066")) +
  theme(strip.text = element_text(size=18),
        axis.text.x = element_text(size=16),
...
#2c2
setwd("X")
png(filename="Panel2C2.png", res=600, width=5500, height=3600)
ggbarplot(filter(PITchange.PREVENTmeta, !is.na(apoe4)), 
               x="Multi-hereditary risk",y="meanDdifferrorAbs",color="Multi-hereditary risk",fill="Multi-hereditary risk",
               add=c("mean_se","jitter"),ylab = "Change in distance error (m)",ggtheme=theme_minimal()) +
  scale_color_manual(values=c("#4A6990","#7AA6DC","#003C67","#EFC000")) +
  scale_fill_manual(values=c("#003C6766","#4A699066","#7AA6DC66","#EFC00066")) +
  theme(strip.text = element_text(size=18),
        axis.text.x = element_text(size=16),
...
lm_ADerror<-lm(data=PITchange.PREVENTmeta.MRI, meanADerror ~ GCmagnitude_allRuns_pmECDTI_right_6 * DRS_noAP  + genderLabs + encrypt_age + nbeduc)
setwd("X")
png(filename="Panel3D1.png", res=600, width=5000, height=3600)
interact_plot(lm_ADerror, pred = GCmagnitude_allRuns_pmECDTI_right_6 , modx = DRS_noAP, interval = TRUE,
              x.label = "Magnitude of hexadirectional grid-like representations",
              y.label = "Change in location error (m)",
              legend.main = "CAIDE") +
...
#3d2
setwd("X")
png(filename="Panel3D2.png", res=600, width=5000, height=3600)
...
#3b
setwd("X")
png(filename="Panel3B.png", res=600, width=5000, height=3600)
ggscatter(PITchange.PREVENTmeta.MRI, x="GCmagnitude_allRuns_pmECDTI_right_6",y="meanADerror",
          add = "reg.line",conf.int = TRUE,palette="jco",ggtheme=theme_minimal(),
          xlab = "Magnitude of hexadirectional grid-like representations", ylab = "Change in location error (m)") +
  stat_cor(method="pearson",digits=2,size = 6) +
  theme(strip.text = element_text(size=18),
        axis.text.x = element_text(size=16),
        axis.text.y = element_text(size=16),
...
#3e
setwd("X")
png(filename="Panel3E.png", res=600, width=5000, height=3600)
ggscatter(PITchange.PREVENTmeta.MRI, x="GCmagnitude_allRuns_pmECDTI_right_1",y="meanADerror",
          add = "reg.line",conf.int = TRUE,palette="jco",ggtheme=theme_minimal(),
          xlab = "Magnitude of unidirectional grid-like representations", ylab = "Change in location error (m)") +
  stat_cor(method="pearson",digits=2,size=6) +
  theme(strip.text = element_text(size=18),
        axis.text.x = element_text(size=16),
        axis.text.y = element_text(size=16),
...
#3F
setwd("X")
png(filename="Panel3F.png", res=600, width=5000, height=3600)
ggscatter(PITchange.PREVENTmeta.MRI, x="GCmagnitude_allRuns_pmECDTI_right_1",y="meanADerror",color="Risk",facet.by="genderLabs",
          add = "reg.line",conf.int = TRUE,palette="jco",ggtheme=theme_minimal(),
          xlab = "Magnitude of unidirectional grid-like representations", ylab = "Change in location error (m)") +
  stat_cor(aes(color=Risk),method="pearson",digits=2,size=6,label.y = c(2.2,2.0),label.x.npc="left") +
  theme(strip.text = element_text(size=18),
        axis.text.x = element_text(size=16),
        axis.text.y = element_text(size=16),
        axis.title.x = element_text(size=18),
...
#3C
setwd("X")
png(filename="Panel3C.png", res=600, width=5000, height=3600)
ggscatter(PITchange.PREVENTmeta.MRI, x="GCmagnitude_allRuns_pmECDTI_right_6",y="meanADerror",color="Risk",facet.by="genderLabs",
          add = "reg.line",conf.int = TRUE,palette="jco",ggtheme=theme_minimal(),
          xlab = "Magnitude of hexadirectional grid-like representations", ylab = "Change in location error (m)") +
  stat_cor(aes(color=Risk),method="pearson",digits=2,size = 6,label.y = c(2.2,2.0),label.x.npc="left") +
  theme(strip.text = element_text(size=18),
